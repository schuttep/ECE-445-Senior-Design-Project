...
Met to discuss what needs to be completed by Sunday 03/08 and what needs to be done by the time Spring Break starts. Payton and I tasked with getting the breadboard code done before the Breadboard Demo scheduled for 03/09. 
